...
class Leg {
  public:
    Leg(LegServo* hipServo, LegServo* shoulderServo, LegServo* kneeServo, bool invertHip, bool invertKnee);
    LegServo* hip;
    LegServo* shoulder;
    LegServo* knee;
    void setDefault();
...
Leg::Leg(LegServo* hipServo, LegServo* shoulderServo, LegServo* kneeServo, bool invertHip, bool invertKnee){
  hip = hipServo;
